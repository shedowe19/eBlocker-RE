...
public final class IcapHeaders {
	...
	/**
	 * Convenience method to retrieve the {@link Integer} value from a Icap Preview header.
	 * If the header does not exist the value -1 is returned.
	 * If the header value cannot be parsed into a valid integer a {@link IcapDecodingError} is thrown.
	 * 

...
/**
 * An ICAP message that contains common operations for {@link IcapRequest} and {@link IcapResponse}.
 * 
...
public interface IcapMessage extends ReferenceCounted {
    ...
    /**
     * @return the {@link Integer} preview header value.
     */
     ...
     * @param version {@link IcapVersion}
     * @return self in order to chain the method calls
     */
    ...
    /**
     * @return the actual http request instance {@link HttpRequest}
     */
	...
	/**
	 * @return the actual http response instance {@link HttpResponse}
	 */
	FullHttpResponse getHttpResponse();
	
	/**
	 * Adds a {@link HttpResponse} to the Icap message.
	 * 
	...
	/**
	 * Sets the {@link Encapsulated} Encapsulation header for this message
	 * @param encapsulated {@link Encapsulated} instance
	 * @return self in order to chain the method calls
	 */
	IcapMessage setEncapsulatedHeader(Encapsulated encapsulated);
	
	/**
	 * @return {@link Encapsulated} Encapsulated header value
	 */
	Encapsulated getEncapsulatedHeader();

	/**
	 * Sets the indication that this icap message contains a body of some kind.
	 * @param body {@link IcapMessageElementEnum}
	 * @return self in order to chain the method calls
	 */
	IcapMessage setBody(IcapMessageElementEnum body);

	/**
	 * @return {@link IcapMessageElementEnum} message body indicator.
	 */

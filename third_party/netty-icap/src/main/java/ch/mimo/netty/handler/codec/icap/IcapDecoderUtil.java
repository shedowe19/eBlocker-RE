...
public final class IcapDecoderUtil {
     ...
     * @param buffer {@link ByteBuf} that contains the headers.
     ...
     * @throws DecodingException if the maximum size is reached.
     */
	 ...
	 * @throws DecodingException In case the total header length is exceeded.
	 */

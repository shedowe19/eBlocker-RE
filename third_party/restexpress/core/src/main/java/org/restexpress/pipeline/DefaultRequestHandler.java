...
extends SimpleChannelInboundHandler<FullHttpRequest>
{
	...
	throws Exception
	{
		...
		// Trusted transport metadata: Host/Forwarded headers and Request.getScheme()
		// cannot establish whether this connection actually uses TLS.
		context.getRequest().putAttachment("transport.secure", ctx.pipeline().get(io.netty.handler.ssl.SslHandler.class) != null);

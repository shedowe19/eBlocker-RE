...
public class NetworkAddressFactoryCustomizationTest {
    ...
    @Test
    public void ipv6IsNotInterpretedAsAnIpv4Subnet() throws UnknownHostException {
        Assert.assertFalse(factoryCustomization.isUsableAddress("eth0", InetAddress.getByName("fd00::1")));
        Assert.assertFalse(factoryCustomization.isUsableAddress("eth0", InetAddress.getByName("fe80::1")));
    }

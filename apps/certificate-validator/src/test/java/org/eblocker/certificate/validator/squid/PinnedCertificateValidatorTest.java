...
class PinnedCertificateValidatorTest {
    ...
    static void beforeClass() throws IOException, CryptoException {
        PINNED_CERTIFICATE = LocalCertificateAuthority.INSTANCE.root;
        NOT_PINNED_CERTIFICATE = LocalCertificateAuthority.INSTANCE.valid;
        EXPIRE_CERTIFICATE = LocalCertificateAuthority.INSTANCE.expired;
    }

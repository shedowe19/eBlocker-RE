...
public class CertificateValidatorTestUtil {
    ...
    public static CertificateValidationRequest createValidRequest(boolean useConcurrency) throws IOException, CryptoException {
        return localRequest(useConcurrency, LocalCertificateAuthority.INSTANCE.valid);
    }
    ...
    public static CertificateValidationRequest createInvalidRequest(boolean useConcurrency) throws IOException, CryptoException {
        return localRequest(useConcurrency, LocalCertificateAuthority.INSTANCE.expired);
    }
    ...
    public static CertificateValidationRequest createRevokedRequest(boolean useConcurrency) throws IOException, CryptoException {
        return localRequest(useConcurrency, LocalCertificateAuthority.INSTANCE.revoked);
    }

    private static CertificateValidationRequest localRequest(boolean concurrent, X509Certificate leaf) {
        return new CertificateValidationRequest(getNextId(concurrent), null, null, "validator.test",
                new X509Certificate[]{leaf, LocalCertificateAuthority.INSTANCE.root}, null, null, concurrent);
    }
